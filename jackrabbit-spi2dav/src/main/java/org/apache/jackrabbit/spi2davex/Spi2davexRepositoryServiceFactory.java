...
public class Spi2davexRepositoryServiceFactory implements RepositoryServiceFactory {
    ...
    public RepositoryService createRepositoryService(Map<?, ?> parameters) throws RepositoryException {
        ...
        RepositoryServiceImpl repo = new RepositoryServiceImpl(uri, workspaceNameDefault, brc, itemInfoCacheSize, ConnectionOptions.fromServiceFactoryParameters(parameters));
